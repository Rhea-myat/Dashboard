...
.hero-title {{
    ...
    margin: 140px auto 0; 
    color: #E6F3FF;
    font-size: clamp(50px, 8vw, 120px); /* Responsive font size */
    text-shadow:
        3px 3px 0 #007BFF,
        6px 6px 0 #00BFFF,
...
.astro {{
    position: absolute;
    top: 5%;                       /* Percentage-based positioning */
    right: 5%;                     /* Percentage-based positioning */
    width: 20vw;                   /* Responsive width */
    height: 20vw;                  /* Responsive height */
    max-width: 250px;              /* Maximum size */
    max-height: 250px;             /* Maximum size */
    z-index: 10;
